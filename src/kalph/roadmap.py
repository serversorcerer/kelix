"""Parse `.kalph/roadmap.md` — milestones, phases, and REQ coverage."""
...
def load_roadmap(kalph_dir: Path | str) -> Roadmap | None:
    """Load roadmap.md from *kalph_dir*. Missing file returns None."""
    path = Path(kalph_dir) / "roadmap.md"
    if not path.is_file():
        return None
