...
- [ ] C1: Repo scaffold: pyproject.toml, package layout, LICENSE (Apache-2.0), .gitignore, stub README
- [ ] C2: Config loader (kalph.toml): agent adapter cmd, verify commands, caps, budgets; defaults safe
